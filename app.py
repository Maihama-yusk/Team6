...
def handle_image_message(event):
    ...
    if request_message == '1':
        ...
        reply_messages.append(TextSendMessage(text="1:"+str(a[0])))
        reply_messages.append(TextSendMessage(text="2:"+str(a[1])))
        reply_messages.append(TextSendMessage(text="3:"+str(a[2])))
